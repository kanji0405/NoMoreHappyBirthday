...
class Sprite_BattleCommands extends Sprite{
	...
	knsRichImage(sp, bmp, colors, i){
		const ctx = sp.bitmap._context;
		ctx.save();
		if (this._window.isCommandEnabled(i)){
			ctx.globalCompositeOperation = 'screen';
			ctx.fillStyle = KNS_BattleUICommand[colors][i];
...
class Sprite_PartyCommands extends Sprite_BattleCommands{
	...
	refresh(){
		...
		this._commands.forEach(function(sp, i){
			...
			this.knsRichImage(sp, bmp, 'PARTY_COMMAND_COLORS', i);
		}, this);
	}
	knsUpdateChildren(){
...
class Sprite_ActorCommands extends Sprite_BattleCommands{
	...
	refresh(){
		this._commands.forEach(function(sp, i){
			...
			this.knsRichImage(sp, bmp, 'ACTOR_COMMAND_COLORS', i);
